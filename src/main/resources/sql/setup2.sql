-- =================================================================
-- LGVB Digital Banking System - Database Setup Script (Fixed)
-- =================================================================
...
CREATE TABLE cards (
    ...
    CONSTRAINT fk_cards_wallet FOREIGN KEY (wallet_id) REFERENCES wallets(wallet_id)
...
-- ==============================
-- Default data for dynamic tables
-- ==============================
